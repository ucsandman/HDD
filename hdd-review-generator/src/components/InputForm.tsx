import { useState, useEffect, forwardRef, useImperativeHandle, type FormEvent } from 'react';
...
export const InputForm = forwardRef<{ resetCustomerFields: () => void }, InputFormProps>(
  function InputForm({ onSubmit }, ref) {
